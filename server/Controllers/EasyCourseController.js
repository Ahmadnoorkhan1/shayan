...
const getCourseChapter = async (req, res) => {
    ...
    const question = `Write a paragraph of 800-1200 words for chapter ${data.prompt.chapterNo} of the chapter ${data.prompt.chapter} for the course title of mine = "${data.prompt.title}".....Make sure to return a markdown with headings bold italic and bullets, make sure any chapter does not start with backticks...No extra text`;
    const timeout = new Promise((_, reject) =>
